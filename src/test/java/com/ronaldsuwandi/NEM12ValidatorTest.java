...
class NEM12ValidatorTest {
    ...
    void validateStateMultiple100() {
        ...
        assertThrows(NEM12Exception.class, () -> NEM12Validator.validateState(state, record));
    }

    @Test
    void validateStateMissing100() {
        NEM12FileProcessor.NEM12State state = new NEM12FileProcessor.NEM12State();
        state.has900 = true;
    ...
    @Test
    void validateState200Without100() {
        NEM12FileProcessor.NEM12State state = new NEM12FileProcessor.NEM12State();
        state.has100 = false;
    ...
    @Test
    void validateState300Without100() {
        NEM12FileProcessor.NEM12State state = new NEM12FileProcessor.NEM12State();
        state.has100 = false;
    ...
    @Test
    void validateState300Without200() {
        NEM12FileProcessor.NEM12State state = new NEM12FileProcessor.NEM12State();
        state.has100 = true;
    ...
    @Test
    void validateState900Without100() {
        NEM12FileProcessor.NEM12State state = new NEM12FileProcessor.NEM12State();
        state.has100 = false;
        state.has900 = true;
    ...
    @Test
    void validateState200() {
        NEM12FileProcessor.NEM12State state = new NEM12FileProcessor.NEM12State();
        state.has100 = true;
        state.has900 = false;

        CSVRecord record = CSVHelper.createCSVRecord("200,NEM1201009,E1E2,1,E1,N1,01009,kWh,30,20050610");
        NEM12Validator.validateState(state, record);
    }
    @Test
    void validateState300() {
        NEM12FileProcessor.NEM12State state = new NEM12FileProcessor.NEM12State();
        state.has100 = true;
